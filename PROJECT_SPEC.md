...
- ShopifyQL product rows retain gross units ordered, returned units, net units, discount value, and refund value by product/variant and week. The Bestsellers headline separates discount percentage from refund-value percentage and unit return rate. Refunds are described as processed in the selected period because they can relate to an earlier sale.
